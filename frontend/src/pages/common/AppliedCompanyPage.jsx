...
function AppliedCompanyPage() {
    ...
    return (
        <div className='max-w-7xl mx-auto py-8 px-6 lg:px-8 font-sans'>
                <div className='flex justify-between items-end border-gray-200 pb-4 mb-8 '>
                ...
                <div id="main-body" className='flex flex-col w-full gap-3'>
                    <div className='mt-2 bg-white p-4 rounded-lg border border-blue-100 flex justify-between items-center shadow-sm'>
                            <span className='text-sm font-bold text-gray-600'>Your Application Current Status:</span>
